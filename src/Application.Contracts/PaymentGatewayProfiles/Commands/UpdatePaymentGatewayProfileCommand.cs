...
[DynamicPermission(
    DisplayName = "بروزرسانی درگاه پرداخت آنلاین",
    Group = "PaymentGateways",
    Module = PayMasterConstants.ModuleName,
    Name = null,
    Description = "")]
public class UpdatePaymentGatewayProfileCommand : ICommand<Result<UpdatePaymentGatewayProfileCommandResult>>
{
...
public class UpdatePaymentGatewayProfileCommandResult
{
